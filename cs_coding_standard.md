...
#### 2. Фигурные скобки.  ###
Все что может быть ограничено фигурными скобками, должно быть ими ограничено. Каждая фигурная скобка должна быть в отдельной строке.
...
#### 0. НЕ ИСПОЛЬЗОВАТЬ КВАЛИФИКАТОРЫ ДОСТУПА В ИНТЕРФЕЙСАХ! ####
НЕ ИСПОЛЬЗОВАТЬ КВАЛИФИКАТОРЫ ДОСТУПА В ИНТЕРФЕЙСАХ!
...
*Исключением из правила является создание структуры для инкопсуляции функционала.*
...
#### 3. Immutable/ReadOnly/Concurrent коллекции. ####
При разработке многопоточного/асинхронного кода, необходимо определиться какой тип изменяемости/неизменяемости коллекций требуется, и использовать именно его.
