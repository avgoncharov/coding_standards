...
*Мотивация*: Такой код четко говорит, что возвращается неизменяемая коллекция. Т.е. не изменяется ни ее длинна, ни ее элементы (надо понимать, что состояние отдельного элемента можно изменить, через его методы и свойства).  
